...
import { documentSchema } from '../utils/validation.js';
    ...
    <Layout>
      <section className="max-w-[1400px] mx-auto" aria-label="Documents management">
        <header className="flex flex-col sm:flex-row justify-between items-start gap-4 sm:gap-0 mb-6 sm:mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800 m-0 mb-2 tracking-tight">Documents</h1>
            <p className="text-sm sm:text-base text-gray-600 m-0">Manage and organize your client documents</p>
          </div>
          <AccessibleButton
        ...
        {/* Filters */}
        <div className="bg-white border border-gray-300 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8 shadow-sm">
          <div className="relative mb-4">
            <Search size={20} className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-600" />
            <input 
              type="text" 
              placeholder="Search documents..." 
              value={filters.search} 
              onChange={(e) => setFilters({...filters, search: e.target.value})} 
              className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-3.5 border border-gray-300 rounded-md text-sm sm:text-[0.9375rem] font-sans text-gray-800 bg-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            />
          </div>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center">
            <select 
              ...
              className="px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-md text-sm sm:text-[0.9375rem] font-sans text-gray-800 bg-white cursor-pointer w-full sm:min-w-[150px] focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            >
            ...
            <input 
              ...
              onChange={handleFilterChange} 
              className="px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-md text-sm sm:text-[0.9375rem] font-sans text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent w-full sm:w-auto"
            ...
            <button 
              ...
              className="px-4 sm:px-6 py-2.5 sm:py-3 bg-transparent text-gray-600 border border-gray-300 rounded-md text-sm sm:text-[0.9375rem] font-medium transition-all duration-200 font-sans hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent w-full sm:w-auto"
            >
              Clear Filters
            </button>
          </div>
          ...
          <>
            {ownedDocs.length > 0 && (
              <section className="mb-8" aria-label="My documents" role="region">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4 sm:mb-5 tracking-tight">My Documents ({ownedDocs.length})</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" role="list" aria-label="My documents list">
                  {ownedDocs.map(doc => (
                    <article 
                      key={doc._id}
                      role="listitem"
            ...
            {sharedDocs.length > 0 && (
              <section className="mb-8" aria-label="Shared documents" role="region">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4 sm:mb-5 tracking-tight">Shared With Me ({sharedDocs.length})</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" role="list" aria-label="Shared documents list">
                  {sharedDocs.map(doc => (
                    <article 
                      key={doc._id}
                      role="listitem"
