      ...
      >
        ...
        <header className="mb-6 sm:mb-8">
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800 m-0 mb-2 tracking-tight leading-tight">
              Welcome back, {user?.name?.split(' ')[0] || 'User'}
            </h1>
            <p className="text-sm sm:text-base text-gray-600 font-normal leading-relaxed m-0">
        ...
        <section 
          ...
          role="region"
        >
          <h2 className="text-xl sm:text-[1.375rem] font-semibold text-gray-800 m-0 tracking-tight leading-tight mb-0">Quick Actions</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Recent Clients */}
          <section className="mb-8 sm:mb-12" aria-label="Recent clients" role="region">
            <div className="flex justify-between items-center mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-[1.375rem] font-semibold text-gray-800 m-0 tracking-tight leading-tight">Recent Clients</h2>
              <button 
                onClick={() => navigate('/clients')} 
          ...
          {/* Recent Documents */}
          <section className="mb-8 sm:mb-12" aria-label="Recent documents" role="region">
            <div className="flex justify-between items-center mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-[1.375rem] font-semibold text-gray-800 m-0 tracking-tight leading-tight">Recent Documents</h2>
              <button 
                onClick={() => navigate('/documents')} 
                className="bg-transparent border-none text-gray-600 text-sm font-medium cursor-pointer flex items-center font-sans transition-colors duration-200 hover:text-primary focus:outline-none focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
              >
