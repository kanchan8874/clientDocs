...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-50 p-4 sm:p-6 bg-gradient-to-br from-blue-50/30 to-green-50/30">
      <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-xl border border-gray-200 w-full max-w-[90vw] sm:max-w-[420px] relative overflow-hidden">
        <div className="flex justify-center mb-6">
          <Logo size="lg" />
        </div>
        <h1 className="text-center text-xl sm:text-[1.75rem] font-bold mb-2 text-gray-800 tracking-tight leading-tight">Welcome back</h1>
        <p className="text-center text-sm sm:text-[0.9375rem] text-gray-600 mb-6 sm:mb-8 leading-relaxed">Sign in to your account to continue</p>
