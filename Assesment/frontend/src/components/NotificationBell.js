    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {showDropdown && (
        <div
          ...
          className="absolute top-[calc(100%+0.75rem)] right-0 w-[90vw] sm:w-[22rem] bg-white rounded-xl shadow-xl border border-gray-200 z-[1100] flex flex-col max-h-[28rem] overflow-hidden"
        >
          {/* Header - Fixed */}
