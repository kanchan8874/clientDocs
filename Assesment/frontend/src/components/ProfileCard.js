    ...
    <div className="relative z-[1100]" ref={cardRef}>
      ...
      {isOpen && (
        <div
          ...
          className="absolute top-[calc(100%+12px)] right-0 bg-white rounded-xl sm:rounded-2xl shadow-2xl border border-gray-200 w-[90vw] sm:w-80 overflow-hidden z-[1100] animate-[slide-down-fade_0.2s_cubic-bezier(0.4,0,0.2,1)] backdrop-blur-sm"
        >
          {/* Header */}
